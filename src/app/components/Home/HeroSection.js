...
export default function HeroSection() {
  return (
    <section className='max-w-7xl mx-auto w-full flex flex-wrap justify-between items-center p-5 h-screen isolate'>
        ...
        <div dir='rtl' className='basis-[450px] grow'>
          ...
          <h5 className='text-lg mt-8 max-w-[500px] tracking-wide'>
