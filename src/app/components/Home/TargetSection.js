...
export default function TargetSection() {
  return (
    <section className='max-w-7xl w-full mx-auto flex flex-row-reverse flex-wrap justify-center items-center px-5 mt-5 gap-2'>
        <div dir='rtl' className='basis-[450px] ml-auto'>
            ...
            <h5 className='tracking-wide text-lg mt-5 leading-relaxed'>
